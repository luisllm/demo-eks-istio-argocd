...
resource "aws_iam_role_policy" "aws-load-balancer-controller-iam-policy" {
  name  = "${local.system_name}-aws-load-balancer-controller-policy"
  role  = aws_iam_role.aws-load-balancer-controller-iam-role.name
