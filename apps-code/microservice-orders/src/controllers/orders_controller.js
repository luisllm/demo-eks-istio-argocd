const get = (req, res, next) => {
  try {
    const orders = [
      ...
      { id: '5', productId: '1e', orderFor: 'Clark Kent', deliveryAddress: 'The Daily Planet HQ', deliveryDate: '12/12/2022', deliveryType: 'FAST DELIVERY' },
      { id: '6', productId: '1f', orderFor: 'Test kk', deliveryAddress: 'Test kkkkk', deliveryDate: '12/12/2022', deliveryType: 'FAST DELIVERY' }
    ];
